DROP PROCEDURE IF EXISTS sp_vendedor_perfecto_otros2;
DELIMITER //
CREATE PROCEDURE sp_vendedor_perfecto_otros2(IN tmp_almacen INT)
LANGUAGE SQL
DETERMINISTIC
...
call sp_vendedor_perfecto_otros2(2);