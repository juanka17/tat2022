DROP PROCEDURE IF EXISTS sp_reporte_vendedor_perfecto_otros2;

DELIMITER //

CREATE PROCEDURE sp_reporte_vendedor_perfecto_otros2 ()
LANGUAGE SQL
DETERMINISTIC
...
call sp_reporte_vendedor_perfecto_otros2();