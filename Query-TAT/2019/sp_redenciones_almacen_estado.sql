DROP PROCEDURE IF EXISTS sp_redenciones_almacen_estado;

DELIMITER //

CREATE PROCEDURE sp_redenciones_almacen_estado(IN id_estado INT, IN id_almacen INT)
LANGUAGE SQL
DETERMINISTIC
...
call sp_redenciones_almacen_estado(4,4);