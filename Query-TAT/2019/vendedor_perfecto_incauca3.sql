DROP PROCEDURE IF EXISTS sp_reporte_vendedor_perfecto_incauca3;

DELIMITER //

CREATE PROCEDURE sp_reporte_vendedor_perfecto_incauca3 ()
LANGUAGE SQL
DETERMINISTIC
...
BEGIN
	...
	select
		...
		(select count(id) from redenciones where id_afiliado = ven.id_vendedor and temporada = 102) entregas
	from
...
call sp_reporte_vendedor_perfecto_incauca3();