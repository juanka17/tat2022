DROP PROCEDURE IF EXISTS sp_reporte_vendedor_perfecto_incauca1;

DELIMITER //

CREATE PROCEDURE sp_reporte_vendedor_perfecto_incauca1 ()
LANGUAGE SQL
DETERMINISTIC
...
call sp_reporte_vendedor_perfecto_incauca1();