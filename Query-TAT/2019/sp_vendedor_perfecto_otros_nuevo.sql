DROP PROCEDURE IF EXISTS sp_vendedor_perfecto_global_otros;

DELIMITER //

CREATE PROCEDURE sp_vendedor_perfecto_global_otros (IN tmp_almacen INT)
LANGUAGE SQL
DETERMINISTIC
...
call sp_vendedor_perfecto_global_otros(9);