DROP PROCEDURE IF EXISTS sp_reporte_vendedor_perfecto_otros3;

DELIMITER //

CREATE PROCEDURE sp_reporte_vendedor_perfecto_otros3 ()
LANGUAGE SQL
DETERMINISTIC
...
call sp_reporte_vendedor_perfecto_otros3();