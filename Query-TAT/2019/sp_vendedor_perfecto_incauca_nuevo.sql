DROP PROCEDURE IF EXISTS sp_vendedor_perfecto_global_incauca;

DELIMITER //

CREATE PROCEDURE sp_vendedor_perfecto_global_incauca (IN tmp_almacen INT)
LANGUAGE SQL
DETERMINISTIC
...
call sp_vendedor_perfecto_global_incauca(89);
