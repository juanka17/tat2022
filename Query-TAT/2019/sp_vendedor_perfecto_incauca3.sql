DROP PROCEDURE IF EXISTS sp_vendedor_perfecto_incauca3;

DELIMITER //

CREATE PROCEDURE sp_vendedor_perfecto_incauca3 (IN tmp_almacen INT)
LANGUAGE SQL
DETERMINISTIC
...
call sp_vendedor_perfecto_incauca3(65);