DROP PROCEDURE IF EXISTS sp_ventas_promedio_usuario;

DELIMITER //

CREATE PROCEDURE sp_ventas_promedio_usuario()
BEGIN
...
INNER JOIN periodo per ON ta.id_periodo=per.id;
...
call sp_ventas_promedio_usuario();