...
<head>
    ...
    <script src="js/legalizacion.js?ver=22" type="text/javascript"></script>
    <link rel="stylesheet" href="./css/legalizar.css?ver=4">
    <script type="text/javascript">
        var datos_usuario = <?php echo json_encode($_SESSION["usuario"]); ?>;
        var id_almacen = 0;
        var id_temporada = 0;
        var legalizacion_individual = false;

        if (typeof getParameterByName("id_redencion") !== 'undefined') {
            var seleccionar_almacen = true;
            id_almacen = getParameterByName("id_almacen");
        }

        if (typeof getParameterByName("id_temporada") !== 'undefined') {
...
<body ng-app="legalizacionApp" ng-controller="legalizacionController" class="layout-top-nav" style="height: auto; min-height: 100%;">
            ...
            <section class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-2 offset-md-10">
                        <a class="btn btn-danger" id="btn_atras" onclick="javascript:document.location.href = document.referrer">
                    ...
                    <div class="col-md-offset-1 col-md-8">
                        ...
                        <p>
                            Señor(es):
                            <input type="text" class="form-control" ng-model="legalizacion.almacen" ng-disabled="true" /><br>
                            Ciudad: {{almacen.ciudad}}
                        </p>
                        <p>
                            <b>Referencia:</b> Acta de Entrega - Programa Socios & Amigos (TAT)
                        </p>
                        <p>
                            Apreciados Señores:
                        </p>
                        <p>
                            Por medio de la presente legalizamos la entrega de los productos identificados
                            a continuación , en razón a su participación en el Programa Socios & Amigos (TAT)
                            de GlaxoSmithKline Consumer Healthcare Colombia S.A.S. ("GSK"),
                            identificada con NIT 900.809.229-8, de conformidad con los Términos y
                            Condiciones del mismo
                        </p>
                        <p>
                            <b>Periodo a legalizar:</b>
                            <br />
                            {{legalizacion.premios[0].temporada_otros}}
                        </p>
                        <p>
                            <b>Entregables: </b>
                        </p>
                        ...
                        <br />
                        <p>
                            El recibo de los Entregables no representa incentivo ni recompensa por
                            la compra, prescripción o recomendación pasada, presente o futura de
                            productos GSK y los Entregables no pueden ser transferido a terceros,
                            consumidores o personal que expenda medicamentos o productos fitoterapéuticos
                            al consumidor. Aplican los Términos y Condiciones del Programa.
                        </p>
                        <br />
                        <br />
                        <br />
                        ...
                        <div class="col-md-offset-1 col-md-4">
                            <b>Fecha de entrega </b><input class="form-control" type='text' ng-model="legalizacion.fecha_entrega" /><br />
                        </div>
                        <div class="col-md-offset-1 col-md-4">
                            <b>Nombre Cliente </b>
                        ...
                        <div class="col-md-offset-1 col-md-10">
                            <img id="sig-image-confirmed" src="" alt="Firma no registrada!" ng-show="legalizacion.firma_vendedor != ''" />
                            <br />
                            <button class="btn btn-primary" data-toggle="modal" data-target="#singModal" ng-click="AbrirModalFirmaVendedor()">Firma Cliente</button>
                        </div>
                        <div class="col-md-offset-1 col-md-4">
                            <br />
                            <br />
                            <b>Nombre Ejecutivo que legaliza</b>
                            <input class="form-control" type='text' ng-model="datos_usuario.nombre" ng-disabled="true" />
                        </div>
                        <div class="col-md-offset-1 col-md-10">
                            <img id="sig-image-confirmed1" src="" alt="Firma no registrada!" ng-show="legalizacion.firma_visitador != ''" />
                            <br />
                            <button class="btn btn-primary" data-toggle="modal" data-target="#singModal1" ng-click="AbrirModalFirmaVisitador()">Firmar Ejecutivo</button>
                        </div>
                        <div class="col-md-offset-1 col-md-10" ng-init="boton = 1">
                            <br />
                            <br />
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="btn btn-primary" id="sig-submitBtn" ng-click="GuardarFirmaVendedor()" ng-show="legalizacion.firma_vendedor == ''" data-dismiss="modal">
                        Clic aquí para confirmar firma cliente
                    </button>
                ...
                <div class="modal-body">
                    ...
                    <img id="sig-image" src="" alt="Firma no registrada!" ng-show="legalizacion.firma_vendedor != ''" />
                    <br />
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="singModal1" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <button class="btn btn-primary" id="sig-submitBtn1" ng-click="GuardarFirmaVisitador()" ng-show="legalizacion.firma_visitador == ''" data-dismiss="modal">
                        Clic aquí para confirmar firma ejecutivo
                    </button>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
