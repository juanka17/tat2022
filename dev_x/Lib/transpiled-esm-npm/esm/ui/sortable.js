...
var Sortable = Draggable.inherit({
  ...
  dragEnd: function dragEnd(sourceEvent) {
    ...
    (_sourceEvent$fromComp = (_sourceEvent$fromComp2 = sourceEvent.fromComponent)._unsubscribeFromSourceScroll) === null || _sourceEvent$fromComp === void 0 ? void 0 : _sourceEvent$fromComp.call(_sourceEvent$fromComp2);
    (_sourceEvent$toCompon = (_sourceEvent$toCompon2 = sourceEvent.toComponent)._unsubscribeFromSourceScroll) === null || _sourceEvent$toCompon === void 0 ? void 0 : _sourceEvent$toCompon.call(_sourceEvent$toCompon2);
