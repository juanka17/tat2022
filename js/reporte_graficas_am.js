angular.module('reporteGraficasApp', ['chart.js']).controller('reporteGraficasController', function ($scope, $http) {
    ...
    $scope.MostrarDatosGraficaCrecimientoAnual = function (data)
    {
        ...
        } else
        {
            ...
            let temp_obj_ventas = {periodo: '', ventas_2019: 0, ventas_2020: 0};
            let temp_obj_impactos = {periodo: '', impactos_2019: 0, impactos_2020: 0};
            ...
            for (i in dg.data)
            {
                ...
                if (temp_obj_ventas.periodo != dg.data[i].periodo)
                {
                    if (temp_obj_ventas.periodo != '')
                    {
                        ...
                        temp_obj_ventas = {periodo: '', ventas_2019: 0, ventas_2020: 0};
                    }
                ...
                if (temp_obj_impactos.periodo != dg.data[i].periodo)
                {
                    if (temp_obj_impactos.periodo != '')
                    {
                        ...
                        temp_obj_impactos = {periodo: '', impactos_2019: 0, impactos_2020: 0};
                    }
            ...
            new Morris.Bar({
                ...
                xkey: 'periodo',
                ykeys: ['impactos_2019', 'impactos_2020'],
                labels: ['2019', '2020'],
                barColors: ['#ff0700', '#41C26D', '#1222e4', '#7248B7']
            });
            new Morris.Bar({
    ...
    $scope.MostrarIndicadoresCumplimiento = function (data)
    {
        ...
        {
            let temp_obj_ventas = {periodo: '', cuota: 0, cumplimiento: 0};
            let temp_obj_impactos = {periodo: '', cuota: 0, cumplimiento: 0};
            ...
            for (i in dgcumplimiento.data)
            {
                if (temp_obj_ventas.periodo != dg.data[i].periodo)
                {
                    if (temp_obj_ventas.periodo != '')
                    {
                        chart_data_ventas.push(temp_obj_ventas);
                        chart_data_impactos.push(temp_obj_impactos);
                        temp_obj_ventas = {periodo: '', cuota: 0, cumplimiento: 0};
                        temp_obj_impactos = {periodo: '', cuota: 0, cumplimiento: 0};
                    }
                    ...
                    if (dg.data[i].cuotas != null)
                    {
                        ...
                        temp_obj_ventas.cumplimiento = dg.data[i].ventas;
                    }
                    ...
                    if (dg.data[i].cuota_impactos != null)
                    {
                        ...
                        temp_obj_impactos.cumplimiento = dg.data[i].impactos;
                    }
                }
            }
            chart_data_ventas.push(temp_obj_ventas);
            ...
            new Morris.Bar({
                ...
                data: chart_data_ventas,
                xkey: 'periodo',
                ykeys: ['cuota', 'cumplimiento'],
                labels: ['Cuota', 'Cumplimiento'],
                preUnits: "$",
                barColors: ['#ff0700', '#41C26D', '#1222e4', '#7248B7']
            });
