...
class clsRedenciones
{
    public static function EjecutarOperacion($operacion, $parametros)
    {
        switch ($operacion) {
            case "Redimir":
                return clsRedenciones::Redimir($parametros);
                break;
            case "ObtenerRedenciones":
                return clsRedenciones::ObtenerRedenciones($parametros);
                break;
            case "ObtenerRedencionesEntregadas":
                return clsRedenciones::ObtenerRedencionesEntregadas($parametros);
                break;
            case "RegistrarBonoEntregado":
                return clsRedenciones::RegistrarBonoEntregado($parametros);
                break;
            case "CancelaRedencion":
                return clsRedenciones::CancelaRedencion($parametros);
                break;
            case "ModificarEstadoRedencionMasivo":
                return clsRedenciones::ModificarEstadoRedencionMasivo($parametros);
                break;
            case "RegistrarRedencion":
                return clsRedenciones::RegistrarRedenciones($parametros);
                break;
            case "registrar_seguimiento_redencion":
                return clsRedenciones::RegistrarOperacionRedenciones($parametros);
                break;
        }
    }
    ...
    private static function RegistrarOperacionRedenciones($parametros)
    {
